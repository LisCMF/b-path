...
const UserInfrastructureRate = prop => {
    // declare a constant dispatch
    const dispatch = useDispatch();
    // contain the result number after triger event
    const individualInfrastructureRate = useSelector(state => state.bpathReducer.individualInfrastructureRate); // select the element 
    ...
    const handleChange1 = () => dispatch(rateInfrastructure(1));
    const handleChange2 = () => dispatch(rateInfrastructure(2));
    const handleChange3 = () => dispatch(rateInfrastructure(3));
    const handleChange4 = () => dispatch(rateInfrastructure(4));
    const handleChange5 = () => dispatch(rateInfrastructure(5));

    return(
        <div className='rate1to5'>
            <div className='rateLabel'>Infrastructure Rate</div>
            ...
            <div className='rateLabel'>-{individualInfrastructureRate}-</div>
        </div>
    )
}


export default UserInfrastructureRate;
/*
 const intialState = {
